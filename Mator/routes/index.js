...
router.post('/', (request, response) => {
  const transporter = nodemailer.createTransport({
	...
	var htmlBody = `Correo Electronico: ${request.body.correo_electronico} <br> Numero de telefono: ${request.body.telefono} <br> Materia: ${request.body.materia_select} <br> Tipo: ${request.body.tipo} <br> Descripion y requisitos: ${request.body.descripcion}`;
	var mail = {
